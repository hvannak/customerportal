...
class VerifyUserData extends StatefulWidget {
  ...
  final int random;
  VerifyUserData({this.body,this.random});
  @override
  _VerifyUserDataState createState() => _VerifyUserDataState(this.body,this.random);
}

class _VerifyUserDataState extends State<VerifyUserData> {
  final Map<String, dynamic> body;
  final int random;
  _VerifyUserDataState(this.body,this.random);
